...
You can help us to make [MDM Agent for Android](https://github.com/flyve-mdm/android-mdm-agent/) becomes better and better by contributing to the project on GitHub.

Just follow our [Contributing guidelines](https://github.com/flyve-mdm/android-mdm-agent/blob/develop/CONTRIBUTING.md), there is explained in detail everything you need to know to become a Flyve MDM Contributor.
