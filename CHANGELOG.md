...
<a name="2.21.0"></a>
# [2.21.0](https://github.com/flyve-mdm/flyve-mdm-android-agent/compare/0.99.46...2.21.0) (2018-05-18)
...
* **policies:** add disable wifi pattern ([12b77ca](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/12b77ca))
* **policies:** add disable wifi pattern ([eac7dab](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/eac7dab))
* **policies:** add get policies by name method ([f8e973a](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/f8e973a))
* **policies:** add get policy by method ([92d0d27](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/92d0d27))
...
* **policies:** create a new pattern for policies ([4be4061](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/4be4061))
...
* **policies:** improve the policies patterns ([d34c029](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/d34c029))
...
* **policies:** return the priority value ([b0b28de](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/b0b28de))
* **policy:** add airplane mode policy pattern ([290fef7](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/290fef7))
* **policy:** add bluetooth pattern policy ([1bcb091](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/1bcb091))
...
* **policy:** add gps policy pattern ([37c5972](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/37c5972))
* **policy:** add Hostpot Tethering policy pattern ([92fa848](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/92fa848))
* **policy:** add maximum failed password for wipe policy pattern ([a42687f](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/a42687f))
* **policy:** add maximum time to lock policy pattern ([05e48f1](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/05e48f1))
* **policy:** add mobile line policy pattern ([ac3a5ce](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/ac3a5ce))
...
* **policy:** add nfc policy pattern ([c36f3d4](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/c36f3d4))
* **policy:** add password enable policy pattern ([dd5ddf3](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/dd5ddf3))
* **policy:** add password min length policy pattern ([bfa271d](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/bfa271d))
* **policy:** add password min letter policy pattern ([f1b6da1](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/f1b6da1))
* **policy:** add password min non letter policy pattern ([12ca576](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/12ca576))
* **policy:** add password min numeric policy pattern ([aa010f1](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/aa010f1))
* **policy:** add password min symbols policy pattern ([dd68b39](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/dd68b39))
* **policy:** add password min upper and lower length policy pattern ([f827e8a](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/f827e8a))
* **policy:** add password quality policy pattern ([e28ca43](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/e28ca43))
* **policy:** add roaming policy pattern ([2bd05bd](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/2bd05bd))
* **policy:** add screen capture policy pattern ([6fc1592](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/6fc1592))
...
* **policy:** add sms mms policy pattern ([af09552](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/af09552))
* **policy:** add speaker phone policy pattern ([071c390](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/071c390))
* **policy:** add status bar policy pattern ([aa00a94](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/aa00a94))
* **policy:** add storage encryption policy pattern ([d29d3da](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/d29d3da))
* **policy:** add stream accessibility policy pattern ([b1dd74f](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/b1dd74f))
* **policy:** add stream alarm policy pattern ([242fc6e](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/242fc6e))
* **policy:** add stream dtmf policy pattern ([66bf110](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/66bf110))
* **policy:** add stream music policy pattern ([bdcee9b](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/bdcee9b))
* **policy:** add stream notification policy pattern ([2ada828](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/2ada828))
* **policy:** add stream ring policy pattern ([3e47a60](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/3e47a60))
* **policy:** add stream voice call policy pattern ([059ac03](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/059ac03))
* **policy:** add usb adb policy pattern ([d46fa38](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/d46fa38))
* **policy:** add usb mtp policy pattern ([c19a42e](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/c19a42e))
* **policy:** add usb ptp policy pattern ([c4a24dd](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/c4a24dd))
* **policy:** add vpn policy pattern ([ca198a8](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/ca198a8))
* **policy:** check the value type ([6e552d7](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/6e552d7))
* **policy:** implement bluetooth policy on the service ([ef6e9cd](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/ef6e9cd))
* **policy:** implement camera policy on the service ([3fbf468](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/3fbf468))
...
* **policy:** implement GPS policy pattern ([7cacb6f](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/7cacb6f))
* **policy:** implement phone state listener ([c65a0cc](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/c65a0cc))
* **policy:** implement roaming policy pattern ([dc10a01](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/dc10a01))
...
* **policy:** reorder methods ([42b2453](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/42b2453))
* **policy:** request new sms permissions ([3167229](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/3167229))
* **policy:** set the value to object type ([01754b3](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/01754b3))
* **policy:** validate if the policies from database has values ([37b2da4](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/37b2da4))
* **policy:** validate methods improve pattern ([35fb12d](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/35fb12d))
* **policy:** validate mqtt information ([fcd23d3](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/fcd23d3))
* **priority:** add priority parameter on camera ([25075ad](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/25075ad))
* **priority:** add priority parameter on policies method ([878582c](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/878582c))
* **priority:** check priority value ([5277d4d](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/5277d4d))
* **priority:** implement priority field on data ([ec4ef0d](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/ec4ef0d))
* **priority:** implement priority on policies ([0965d5a](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/0965d5a))
* **priority:** update database version to 7 ([1670c10](https://github.com/flyve-mdm/flyve-mdm-android-agent/commit/1670c10))
...
<a name="2.20.0"></a>
# [2.20.0](https://github.com/flyve-mdm/flyve-mdm-android-agent/compare/0.99.46...2.20.0) (2018-05-18)
...
<a name="2.19.0"></a>
# [2.19.0](https://github.com/flyve-mdm/flyve-mdm-android-agent/compare/0.99.46...2.19.0) (2018-05-15)
...
<a name="2.16.0"></a>
# [2.16.0](https://github.com/flyve-mdm/flyve-mdm-android-agent/compare/0.99.46...2.16.0) (2018-05-11)
...
<a name="2.15.0"></a>
# [2.15.0](https://github.com/flyve-mdm/flyve-mdm-android-agent/compare/0.99.46...2.15.0) (2018-05-10)
